...
class WebGame(Env):
    def __init__(self):
        ...
        self.cap = mss()
        self.game_location = {'top': 320, 'left': 0, 'width': 400, 'height': 300}
        self.done_location = {'top': 350, 'left': 230, 'width': 300, 'height': 70}
...
CHECKPOINT_DIR = './python/script_outputs/dino_train/'
LOG_DIR = './python/script_outputs/dino_logs/'
